...
Ever since I read the book I have been appying what I learned to my work.
...
Like believing that the tools I use are the best and only tools one should use, and anything else is inverior and not worth the time.

On the contrary, I found value in every single thing I expolored that fell outside my comfort zone.
...
{/* It must be how it feels for addrenaline junkies to skydive or jump a bike. */}

I am plesently surprise when my predifined idea of how something probably works gets shattered by how it actually works.
...
{/* The book has many more such fasicinating examples and I would urge anyone to read it 
...
This has allowed me to broaden my knwoledge extensively, and learn at a fast pace

I do not intend to jump on every hot new thing that makes an appearance, 
I intend to learn what is valuable, not always necessarily monetarily, but valuable in terms of brodening my horizon.
